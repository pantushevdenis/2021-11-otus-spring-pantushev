package ru.otus.spring.pantushev.initDb;
...
public class InitDatabase {
...

    {
        try {
            ...
            books.add(new Book("Старик Хоттабыч",
                    new AuthorElement(authors.get(2)),
                    new JenreElement(jenres.get(5)),
                    1990));
            books.add(new Book("Денискины рассказы",
                new AuthorElement(authors.get(3)),
                new JenreElement(jenres.get(2)),
                2001));
    ...
    public InitDatabase(AuthorsRepository authorsRepository, JenresRepository jenresRepository, BooksRepository booksRepository) {
