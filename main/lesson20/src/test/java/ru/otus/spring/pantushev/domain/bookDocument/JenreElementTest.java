...
public class JenreElementTest {
    ...
    private static Jenre JENRE_1 = new Jenre(ID_1, FULL_NAME_1, SHORT_NAME_1);
    ...
    @Test
    @DisplayName("Создается конструктором из домена Jenre")
    public void shouldConstructFromJenre() {
        JenreElement je = new JenreElement(JENRE_1);
