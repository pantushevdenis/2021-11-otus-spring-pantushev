...
{
    private final QuestionsDaoConfig questionsDaoConfig;

    @Autowired
    public QuestionDaoResourceCSV(QuestionsDaoConfig questionsDaoConfig) {
        this.questionsDaoConfig = questionsDaoConfig;
    }
    ...
    public QuestionsList getQuestionsList()
            throws Exception
    {
        String filename = questionsDaoConfig.getResourcecsv().getFilename();
